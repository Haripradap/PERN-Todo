...
<div className="modal" id={`id${todo.todo_id}`} onClick={() => todo.description}>
  <div className="modal-dialog">
    <div className="modal-content">
      ...
      <div className="modal-header">
        ...
        <button type="button" className="close" data-dismiss="modal" onClick={() => todo.description}>&times;</button>
      </div>
      ...
      <div className="modal-footer">
        ...
        <button type="button" className="btn btn-danger" data-dismiss="modal" onClick={() => todo.description}>Close</button>
      </div>
